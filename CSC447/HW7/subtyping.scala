...
object subtyping:
  ...
  def observeCounter(f: Counter => Unit): Int =
    ...
    class CounterOne extends Counter:
      private var i = 0;
      override def decrement() = {i = i+1}
      override def increment() = {i = i+1}
      override def get(): Int = i
    
    val counter = new CounterOne();
    f(counter);
    counter.get();
  ...
  def observeCounterList(f: List[Counter] => Unit): List[Int] =
    // TODO: Provide definition here.
    class CounterTwo extends Counter:
      private var i = 0;
      override def decrement() = {i = i+1}
      override def increment() = {i = i+1}
      override def get(): Int = i
    ...
    val listOne = new CounterTwo();
    val listTwo = new CounterTwo();
    val listThree = new CounterTwo();
    f(List(listOne, listTwo, listThree));
    list = List(listOne.get(), listTwo.get(), listThree.get());
    list;
  ...
  def observeCounterArray(f: Array[Counter] => Unit): Array[Int] =
    // TODO: Provide definition here.
    class CounterThree extends Counter:
      private var i = 0;
      override def decrement() = {i = i+1}
      override def increment() = {i = i+1}
      override def get(): Int = i
    
    var arrayList: Array[Int] = new Array[Int](3);
    val one = new CounterThree();
    val two = new CounterThree();
    val three = new CounterThree();
    f(Array(one,two,three))
    arrayList = Array(one.get(), two.get(), three.get());
    arrayList;
